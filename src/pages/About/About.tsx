...
const About: React.FC = () => {
  ...
  const GUVOHNOMA_URL = window.location.origin + "/pdfs/journal-guvohnoma.pdf";
  ...
  const scienceFields = t("about.scienceFields", {
    returnObjects: true,
  }) as string[];

  const organizationalInfo = [
    {
      label: t("about.org.editor"),
      value: "Ismoilov Shukurulloh Habibulla o‘g‘li",
    },
    {
      label: t("about.org.secretary"),
      value: "Mengliyev Davlatyor Baxtiyarovich",
    },
    {
      label: t("about.org.address"),
      value: "Urganch shahri, Al - Хorazmiy ko‘chasi, 110",
    },
