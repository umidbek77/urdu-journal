...
export const USEFUL_LINKS: Link[] = [
    { name: 'Urgench State Pedagogical Institute named after Name', logo: 'https://urdu.uz/martxa/martxa/assets/images/logoursu.png', url: '#' },
...
export const CONTACT_INFO: ContactInfo = {
    ...
    email: 'urdujournal@mail.ru',
    address: 'Urgench city, F. Name street without number, index 222000, Uzbekistan',
};
